  ...
  <div class="page-content-block clearfix">
    ...
    <div class="right-side main">
      ...
      <div class="full-width rs-content-box">
        ...
        <ul class="list-custom">
          <li>favoriser la communication et la collaboration au sein de l'industrie afin de développer des expertises globales et d'augmenter la qualité des services offerts;</li>
          <li>transmettre à la relève la passion de la conception et du développement web;</li>
          <li>faire découvrir aux organisations et au grand public l'importance du web et de ses applications, notamment les meilleures pratiques professionnelles;</li>
          <li>faire rayonner l'expertise de notre industrie créative à l'extérieur de Québec et du Québec.</li>
        </ul>
        <p>Pour mener à bien cette mission, nous avons fondé un organisme sans but lucratif, le Web au Québec, dont le conseil d’administration compte six membres. Autour de ce conseil évoluent plusieurs comités pilotés par des bénévoles.</p>
      </div>

      <div class="full-width rs-content-box clearfix">
        <h3 class="box-header">ORGANISATEURS</h3>
        ...
        <div class="left-side rs-content-box iron-web">
          ...
          <ul class="list-custom">
            <li>Simon Bédard</li>
            <li>Joé Bussières</li>
            <li>Carl-Frédéric De Celles</li>
            <li>Jean-Philippe Doyle</li>
            <li>Jonathan Parent</li>
            <li>Gabriel Rodrigue</li>
          </ul>
          <h4>Coordination et permanence</h4>
          <ul class="list-custom">
            <li>Véronique Pâquet</li>
          </ul>
          <h4>Comité programmation</h4>
          <ul class="list-custom">
            <li>Éric Letarte (responsable)</li>
            <li>Félix Bégin</li>
            <li>Louise Bluteau</li>
            <li>Maxime Breton</li>
            <li>Marie-José Gadras</li>
            <li>Amélie Joyal Laplante</li>
            <li>Daniel Lafrenière</li>
            <li>Éric Leblond</li>
            <li>Jason Lemay</li>
            <li>Yannick Pavard</li>
          </ul>
          <h4>Comité opérations</h4>
          <ul class="list-custom">
            <li>Hélène Dufour (responsable)</li>
            <li>Frédéric Beauvais</li>
            <li>Marie-Claude Bélanger</li>
            <li>Stéphanie Carle</li>
            <li>Nicolas-Loic Fortin</li>
            <li>Martin Pilote</li>
            <li>Pierre-Étienne Vachon</li>
          </ul>
        </div>

        <div class="left-side rs-content-box iron-web">
          <h4>Comité Iron Web</h4>
          <ul class="list-custom">
            <li>Jean-Philippe Doyle (responsable)</li>
            <li>Laure-Gabrielle Chatenent</li>
            <li>Xavier Jacques Côté</li>
            <li>Joannie Pellerin</li>
            <li>Étienne Richard</li>
            <li>Amélie Turgeon</li>
          </ul>
          <h4>Comité Finances</h4>
          <ul class="list-custom">
            <li>Gabriel Rodrigue (responsable)</li>
          </ul>
          <h4>Comité communications</h4>
          <ul class="list-custom">
            <li>Samira Benzina (responsable)</li>
            <li>Kim Auclair</li>
            <li>Gabrielle Bernatchez</li>
            <li>Zoé Forest Paradis</li>
            <li>Jean-François Frenette</li>
            <li>Yhoanis Obando</li>
            <li>Yoanna Rigotto</li>
            <li>Étienne Talbot</li>
          </ul>
          <h4>Comité technique</h4>
          <ul class="list-custom">
            <li>Jean-Philippe Sirois (responsable)</li>
            <li>Luc-Olivier Boulet</li>
            <li>Charles Demers</li>
            <li>Karl Lacroix</li>
            <li>Guillaume Gaulin Laquerre</li>
            <li>Jean-Philippe Veilleux</li>
          </ul>
        </div>
